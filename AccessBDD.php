...
class AccessBDD {
     ...
     * @return array|null Lignes de la requete
     */
     ...
     * @return array|null répondant aux critères de recherches
     */	
     ...
     * @param string $table
     * @return array|null triées sur lebelle
     */
     ...
     * récupération de toutes les lignes d'une table
     * @param string $table
     * @return array|null les lignes de la table
     */
     ...
     * @return array|null de la requete
     */
    ...
    public function selectExemplairesRevue($id = null){
        if($id === null){
            $req = "SELECT e.id, e.numero, e.dateAchat, e.photo, e.idEtat FROM exemplaire e ORDER BY e.dateAchat DESC";
        }else{
     ...
     * @return bool si la suppression a fonctionné
     */	
     ...
     * @return bool si l'ajout a fonctionné
     */	
     ...
     * @return bool si la modification a fonctionné
     */	
